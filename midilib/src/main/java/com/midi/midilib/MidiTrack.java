...
package com.midi.midilib;



import com.midi.midilib.event.MidiEvent;
import com.midi.midilib.event.NoteOn;
import com.midi.midilib.event.meta.EndOfTrack;
import com.midi.midilib.event.meta.Tempo;
import com.midi.midilib.event.meta.TimeSignature;
import com.midi.midilib.util.MidiUtil;
import com.midi.midilib.util.VariableLengthInt;
...
public class MidiTrack
{
    ...
    public void writeToFile(OutputStream out) throws IOException
    {
        ...
        while(it.hasNext())
        {
            ...
            System.err.println( "---"+mEvents.toString());
